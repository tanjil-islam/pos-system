    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
			...
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="purchase_price" placeholder="Purchase price" name="purchase_price" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
					...
					<div class="form-group">
	        	<label for="editPurchase_price" class="col-sm-3 control-label">Purchase price: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="editPurchase_price" placeholder="Purchase price" name="editPurchase_price" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->
